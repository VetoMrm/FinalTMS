...
export class HoldTicketComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    if(this.designation=='Admin'){
       this.getAdminHoldTickets(this.userId);
    }
    if(this.designation=='User'){
        this.getUserHoldTickets(this.userId);
    }
    if(this.designation=='Assigned_User'){
       this.getAssignedHoldTicket(this.userId);
    }
  ...
  getAdminHoldTickets(userId:number){
    this.ticketService.getAdminHoldTickets(userId)
    .subscribe(response=>{
  ...
  getUserHoldTickets(userId:number){
    this.ticketService.getUserHoldTickets(userId)
    .subscribe(response=>{
    this.dataSource = new MatTableDataSource(response.object.ticketList);
  ...
  getAssignedHoldTicket(userId:number){
    this.ticketService.getAssignedUserHoldTickets(userId)
    .subscribe(response=>{
    this.dataSource = new MatTableDataSource(response.object.ticketList);
