...
export class FixedTicketComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    if(this.designation=='Admin'){
       this.getAdminFixedTickets(this.userId);
    }
    if(this.designation=='User'){
        this.getUserFixedTickets(this.userId);
    }
    if(this.designation=='Assigned_User'){
       this.getAssignedFixedTicket(this.userId);
    }
  ...
  getAdminFixedTickets(userId:number){
    this.ticketService.getAdminFixedTickets(userId)
    .subscribe(response=>{
  ...
  getUserFixedTickets(userId:number){
    this.ticketService.getUserFixedTickets(userId)
    .subscribe(response=>{
    this.dataSource = new MatTableDataSource(response.object.ticketList);
  ...
  getAssignedFixedTicket(userId:number){
    this.ticketService.getAssignedUserFixedTickets(userId)
    .subscribe(response=>{
    this.dataSource = new MatTableDataSource(response.object.ticketList);
