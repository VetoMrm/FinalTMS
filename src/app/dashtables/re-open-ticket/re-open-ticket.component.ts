...
export class ReOpenTicketComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    if(this.designation=='Admin'){
       this.getAdminReOpenTickets(this.userId);
    }
    if(this.designation=='User'){
        this.getUserReOpenTickets(this.userId);
    }
    if(this.designation=='Assigned_User'){
       this.getAssignedReOpenTicket(this.userId);
    }
  ...
  getAdminReOpenTickets(userId:number){
    this.ticketService.getAdminReOpenTickets(userId)
    .subscribe(response=>{
  ...
  getUserReOpenTickets(userId:number){
    this.ticketService.getUserReOpenTickets(userId)
    .subscribe(response=>{
    this.dataSource = new MatTableDataSource(response.object.ticketList);
  ...
  getAssignedReOpenTicket(userId:number){
    this.ticketService.getAssignedUserReOpenTickets(userId)
    .subscribe(response=>{
    this.dataSource = new MatTableDataSource(response.object.ticketList);
